!function (t, e) {
    if ("function" == typeof define && define.amd) define(["d3"], e); else if ("object" == typeof module && module.exports) {
        var n = require("d3");
        module.exports = e(n)
    ...
    return function () {
        ...
        function h() {
            ...
            var n = {}, r = e.getScreenCTM(), o = e.getBBox(), l = o.width, i = o.height, f = o.x, u = o.y;
        ...
        var v = n, g = r, w = o, T = y(), b = null, C = null, E = null;
        e.show = function () {
            var t = Array.prototype.slice.call(arguments);
            t[t.length - 1] instanceof SVGElement && (E = t.pop());
            var n, r = w.apply(this, t), o = g.apply(this, t), l = v.apply(this, t), i = m(), f = S.length,
        ...
        var H = t.map({n: l, s: i, e: f, w: u, nw: s, ne: a, sw: c, se: p}), S = H.keys();
        return e
    }
});
